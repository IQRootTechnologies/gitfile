...
//        ipEditText.setText(mContext.getSharedPreferences(PREF_COMMON, 0).getString(PREF_KEY_INPUT_RECEIVER, ""));
    ...
    {
        Toast.makeText(MainActivity.this,
                "Fashion", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(MainActivity.this,Fashion.class));
    }
    public  void startLaptop(View v)
    {
        Toast.makeText(MainActivity.this,
                "Laptop", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(MainActivity.this,Laptop.class));
    }
    public  void startWatch(View v)
    {
        Toast.makeText(MainActivity.this,
                "Watch", Toast.LENGTH_SHORT).show();
    ...
    {
        Toast.makeText(MainActivity.this,
                "Camera Started", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(MainActivity.this,Camera.class));
    }
    public  void clickCast(View v)
    {
        Toast.makeText(MainActivity.this,
                "Welcome to Easy2Buy", Toast.LENGTH_SHORT).show();
    startActivity(new Intent(MainActivity.this,iqute.class));
    }
