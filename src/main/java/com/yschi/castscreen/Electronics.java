...
public class Electronics extends iqute
{
    public ImageButton eleButton;
    public ListView eleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eleList = (ListView) findViewById(R.id.eleList);


        voiceInputButton();
        eleButton.setOnClickListener(this);
    }
    ...
    private void back()
    {
        ...
        Intent eleBackPage = new Intent(this, iqute.class);
        startActivity(eleBackPage);
    }
    }
